...
public class Mjolnir {
	...
	public static void buildContents( BuildCreativeModeTabContentsEvent event ) {
		...
		event.accept(BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath(MOD_ID, "mjolnir")));
	}
	...
	public static void registerItems( RegisterEvent event ) {
		event.register(BuiltInRegistries.ITEM.key(), registry -> {
			...
			registry.register(Identifier.fromNamespaceAndPath(MOD_ID, "mjolnir"),
					new MjolnirItem(new Item.Properties().setId(ResourceKey.create(registry,
							Identifier.fromNamespaceAndPath(MOD_ID, "mjolnir")))));
		});
